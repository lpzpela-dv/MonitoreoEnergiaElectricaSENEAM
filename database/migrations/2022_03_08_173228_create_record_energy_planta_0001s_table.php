...
class CreateRecordEnergyPlanta0001sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('record_energy_planta_0001s', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('record_energy_planta_0001s');
    }
}
