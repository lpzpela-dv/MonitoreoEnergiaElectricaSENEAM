<div class="modal fade" id="AddAeroModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="aeroForm" action="{{ route('aeroRegister') }}">
                    @csrf
                    <div class="row mb-3">
                        <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Nombre Corto') }}</label>

                        <div class="col-md-6">
                            <input id="shortName" type="text" class="form-control @error('name') is-invalid @enderror"
